...
function EnterOtpContent() {
  ...
  const handleResendOtp = async () => {
    ...
    try {
      const result = await axios.post("https://backend.chihili.com/api/auth/resend-otp", payload);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const result = await axios.post("https://backend.chihili.com/api/auth/verify-otp", payload);
      if (result.status === 200) {
